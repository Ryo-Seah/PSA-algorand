...
import { PaymentTxn, KeyRegistrationTxn, MustHaveSuggestedParams, MustHaveSuggestedParamsInline, AssetCreateTxn, AssetConfigTxn, AssetDestroyTxn, AssetFreezeTxn, AssetTransferTxn, AppCreateTxn, AppUpdateTxn, AppDeleteTxn, AppOptInTxn, AppCloseOutTxn, AppClearStateTxn, AppNoOpTxn } from 'algosdk/dist/types/src/types/transactions';
import { RenameProperties, RenameProperty } from 'algosdk/dist/types/src/types/utils';
/**
...
export declare function makeKeyRegistrationTxn(from: KeyRegistrationTxn['from'], fee: MustHaveSuggestedParamsInline<KeyRegistrationTxn>['fee'], firstRound: MustHaveSuggestedParamsInline<KeyRegistrationTxn>['firstRound'], lastRound: MustHaveSuggestedParamsInline<KeyRegistrationTxn>['lastRound'], note: KeyRegistrationTxn['note'], genesisHash: MustHaveSuggestedParamsInline<KeyRegistrationTxn>['genesisHash'], genesisID: MustHaveSuggestedParamsInline<KeyRegistrationTxn>['genesisID'], voteKey: undefined, selectionKey: undefined, voteFirst: undefined, voteLast: undefined, voteKeyDilution: undefined, rekeyTo?: KeyRegistrationTxn['reKeyTo'], nonParticipation?: true): txnBuilder.Transaction;
export declare function makeKeyRegistrationTxnWithSuggestedParamsFromObject(o: Pick<RenameProperty<MustHaveSuggestedParams<KeyRegistrationTxn>, 'reKeyTo', 'rekeyTo'>, 'from' | 'note' | 'voteKey' | 'selectionKey' | 'voteFirst' | 'voteLast' | 'voteKeyDilution' | 'suggestedParams' | 'rekeyTo'> & {
...
export { OnApplicationComplete } from 'algosdk/dist/types/src/types/transactions/base';
/**
...
export declare function makeApplicationCallTxnFromObject(options: Pick<RenameProperties<MustHaveSuggestedParams<AppCreateTxn>, {
    ...
    appForeignAssets: 'foreignAssets';
    reKeyTo: 'rekeyTo';
}>, 'from' | 'suggestedParams' | 'appIndex' | 'onComplete' | 'appArgs' | 'accounts' | 'foreignApps' | 'foreignAssets' | 'note' | 'lease' | 'rekeyTo' | 'extraPages'> & Partial<Pick<RenameProperties<MustHaveSuggestedParams<AppCreateTxn>, {
    appApprovalProgram: 'approvalProgram';
    appClearProgram: 'clearProgram';
    appLocalInts: 'numLocalInts';
    appLocalByteSlices: 'numLocalByteSlices';
