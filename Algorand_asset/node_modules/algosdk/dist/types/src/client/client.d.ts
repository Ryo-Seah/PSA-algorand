import * as utils from 'algosdk/dist/types/src/utils/utils';
import { BaseHTTPClient, Query } from 'algosdk/dist/types/src/client/baseHTTPClient';
import { TokenHeader } from 'algosdk/dist/types/src/client/urlTokenBaseHTTPClient';
...
export default class HTTPClient {
     ...
     */
    post(relativePath: string, data: any, requestHeaders?: Record<string, string>): Promise<HTTPClientResponse>;
    /**
