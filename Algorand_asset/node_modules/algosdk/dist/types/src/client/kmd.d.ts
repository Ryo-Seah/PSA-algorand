...
import * as txn from 'algosdk/dist/types/src/transaction';
...
export default class Kmd extends ServiceClient {
     ...
     * @param walletMDK
     */
    createWallet(walletName: string, walletPassword: string, walletMDK?: string, walletDriverName?: string): Promise<any>;
    /**
     ...
     * @param secretKey
     */
    importKey(walletHandle: string, secretKey: string): Promise<any>;
    /**
