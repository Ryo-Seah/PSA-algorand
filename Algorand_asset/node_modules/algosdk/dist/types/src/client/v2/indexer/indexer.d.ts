import ServiceClient from 'algosdk/dist/types/src/client/v2/serviceClient';
import MakeHealthCheck from 'algosdk/dist/types/src/client/v2/indexer/makeHealthCheck';
import LookupAssetBalances from 'algosdk/dist/types/src/client/v2/indexer/lookupAssetBalances';
import LookupAssetTransactions from 'algosdk/dist/types/src/client/v2/indexer/lookupAssetTransactions';
import LookupAccountTransactions from 'algosdk/dist/types/src/client/v2/indexer/lookupAccountTransactions';
import LookupBlock from 'algosdk/dist/types/src/client/v2/indexer/lookupBlock';
import LookupTransactionByID from 'algosdk/dist/types/src/client/v2/indexer/lookupTransactionByID';
import LookupAccountByID from 'algosdk/dist/types/src/client/v2/indexer/lookupAccountByID';
import LookupAssetByID from 'algosdk/dist/types/src/client/v2/indexer/lookupAssetByID';
import LookupApplications from 'algosdk/dist/types/src/client/v2/indexer/lookupApplications';
import LookupApplicationLogs from 'algosdk/dist/types/src/client/v2/indexer/lookupApplicationLogs';
import SearchAccounts from 'algosdk/dist/types/src/client/v2/indexer/searchAccounts';
import SearchForTransactions from 'algosdk/dist/types/src/client/v2/indexer/searchForTransactions';
import SearchForAssets from 'algosdk/dist/types/src/client/v2/indexer/searchForAssets';
import SearchForApplications from 'algosdk/dist/types/src/client/v2/indexer/searchForApplications';
import { BaseHTTPClient } from 'algosdk/dist/types/src/client/baseHTTPClient';
import { CustomTokenHeader, IndexerTokenHeader } from 'algosdk/dist/types/src/client/urlTokenBaseHTTPClient';
/**
...
export default class IndexerClient extends ServiceClient {
     ...
     */
    constructor(tokenOrBaseClient: string | IndexerTokenHeader | CustomTokenHeader | BaseHTTPClient, baseServer?: string, port?: string | number, headers?: Record<string, string>);
    /**
